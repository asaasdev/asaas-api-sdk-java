...
@EqualsAndHashCode
@Jacksonized
public class PaymentSplitListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PaymentSplitGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<PaymentSplitGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PaymentSplitListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PaymentSplitListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public PaymentSplitListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public PaymentSplitListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public PaymentSplitListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public PaymentSplitListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PaymentSplitGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public PaymentSplitListResponseDtoBuilder data(List<PaymentSplitGetResponseDto> value) {
