...
@EqualsAndHashCode
@Jacksonized
public class ApiInstallmentListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiInstallmentGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiInstallmentGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiInstallmentListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiInstallmentListResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiInstallmentListResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiInstallmentListResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiInstallmentListResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiInstallmentListResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiInstallmentGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiInstallmentListResponseDtoBuilder data(List<ApiInstallmentGetResponseDto> value) {
      if (value == null) {
