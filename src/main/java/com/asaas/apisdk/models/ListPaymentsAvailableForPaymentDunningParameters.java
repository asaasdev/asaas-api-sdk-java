...
@EqualsAndHashCode
@Jacksonized
public class ListPaymentsAvailableForPaymentDunningParameters {
  ...
  public static class ListPaymentsAvailableForPaymentDunningParametersBuilder {

    private JsonNullable<Long> offset = JsonNullable.undefined();

    @JsonProperty("offset")
    public ListPaymentsAvailableForPaymentDunningParametersBuilder offset(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ListPaymentsAvailableForPaymentDunningParametersBuilder limit(Long value) {
      if (value == null) {
