...
public class TransferBankGetResponseDto {
  ...
  public static class TransferBankGetResponseDtoBuilder {

    private JsonNullable<String> ispb = JsonNullable.undefined();

    @JsonProperty("ispb")
    public TransferBankGetResponseDtoBuilder ispb(String value) {
    ...
    @JsonProperty("code")
    public TransferBankGetResponseDtoBuilder code(String value) {
    ...
    @JsonProperty("name")
    public TransferBankGetResponseDtoBuilder name(String value) {
