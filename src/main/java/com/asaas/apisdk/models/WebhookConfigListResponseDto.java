...
@EqualsAndHashCode
@Jacksonized
public class WebhookConfigListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<WebhookConfigGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<WebhookConfigGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class WebhookConfigListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public WebhookConfigListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public WebhookConfigListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public WebhookConfigListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public WebhookConfigListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public WebhookConfigListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<WebhookConfigGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public WebhookConfigListResponseDtoBuilder data(List<WebhookConfigGetResponseDto> value) {
