...
@EqualsAndHashCode
@Jacksonized
public class ListRecurrenceItemsParameters {
  ...
  public static class ListRecurrenceItemsParametersBuilder {

    private JsonNullable<Long> offset = JsonNullable.undefined();

    @JsonProperty("offset")
    public ListRecurrenceItemsParametersBuilder offset(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ListRecurrenceItemsParametersBuilder limit(Long value) {
      if (value == null) {
