...
@EqualsAndHashCode
@Jacksonized
public class PaymentLeanGetResponseDto {
  ...
  private JsonNullable<PaymentLeanGetResponseBillingType> billingType;
   ...
   */
  @JsonProperty("status")
  private JsonNullable<PaymentLeanGetResponsePaymentStatus> status;
  ...
  @JsonIgnore
  public PaymentLeanGetResponseBillingType getBillingType() {
  ...
  @JsonIgnore
  public PaymentLeanGetResponsePaymentStatus getStatus() {
  ...
  public static class PaymentLeanGetResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PaymentLeanGetResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("id")
    public PaymentLeanGetResponseDtoBuilder id(String value) {
    ...
    @JsonProperty("dateCreated")
    public PaymentLeanGetResponseDtoBuilder dateCreated(String value) {
    ...
    @JsonProperty("customerId")
    public PaymentLeanGetResponseDtoBuilder customerId(String value) {
    ...
    @JsonProperty("subscriptionId")
    public PaymentLeanGetResponseDtoBuilder subscriptionId(String value) {
    ...
    @JsonProperty("installmentId")
    public PaymentLeanGetResponseDtoBuilder installmentId(String value) {
    ...
    @JsonProperty("paymentLinkId")
    public PaymentLeanGetResponseDtoBuilder paymentLinkId(String value) {
    ...
    @JsonProperty("value")
    public PaymentLeanGetResponseDtoBuilder value(Double value) {
    ...
    @JsonProperty("netValue")
    public PaymentLeanGetResponseDtoBuilder netValue(Double value) {
    ...
    @JsonProperty("originalValue")
    public PaymentLeanGetResponseDtoBuilder originalValue(Double value) {
    ...
    @JsonProperty("interestValue")
    public PaymentLeanGetResponseDtoBuilder interestValue(Double value) {
    ...
    @JsonProperty("description")
    public PaymentLeanGetResponseDtoBuilder description(String value) {
      this.description = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<PaymentLeanGetResponseBillingType> billingType = JsonNullable.undefined();

    @JsonProperty("billingType")
    public PaymentLeanGetResponseDtoBuilder billingType(PaymentLeanGetResponseBillingType value) {
    ...
    @JsonProperty("canBePaidAfterDueDate")
    public PaymentLeanGetResponseDtoBuilder canBePaidAfterDueDate(Boolean value) {
    ...
    @JsonProperty("confirmedDate")
    public PaymentLeanGetResponseDtoBuilder confirmedDate(String value) {
    ...
    @JsonProperty("pixTransactionId")
    public PaymentLeanGetResponseDtoBuilder pixTransactionId(String value) {
      this.pixTransactionId = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<PaymentLeanGetResponsePaymentStatus> status = JsonNullable.undefined();

    @JsonProperty("status")
    public PaymentLeanGetResponseDtoBuilder status(PaymentLeanGetResponsePaymentStatus value) {
    ...
    @JsonProperty("dueDate")
    public PaymentLeanGetResponseDtoBuilder dueDate(String value) {
    ...
    @JsonProperty("originalDueDate")
    public PaymentLeanGetResponseDtoBuilder originalDueDate(String value) {
    ...
    @JsonProperty("paymentDate")
    public PaymentLeanGetResponseDtoBuilder paymentDate(String value) {
    ...
    @JsonProperty("customerPaymentDate")
    public PaymentLeanGetResponseDtoBuilder customerPaymentDate(String value) {
    ...
    @JsonProperty("installmentNumber")
    public PaymentLeanGetResponseDtoBuilder installmentNumber(Long value) {
    ...
    @JsonProperty("externalReference")
    public PaymentLeanGetResponseDtoBuilder externalReference(String value) {
    ...
    @JsonProperty("deleted")
    public PaymentLeanGetResponseDtoBuilder deleted(Boolean value) {
    ...
    @JsonProperty("anticipated")
    public PaymentLeanGetResponseDtoBuilder anticipated(Boolean value) {
    ...
    @JsonProperty("anticipable")
    public PaymentLeanGetResponseDtoBuilder anticipable(Boolean value) {
    ...
    @JsonProperty("creditDate")
    public PaymentLeanGetResponseDtoBuilder creditDate(String value) {
    ...
    @JsonProperty("transactionReceiptUrl")
    public PaymentLeanGetResponseDtoBuilder transactionReceiptUrl(String value) {
    ...
    @JsonProperty("duplicatedPaymentId")
    public PaymentLeanGetResponseDtoBuilder duplicatedPaymentId(String value) {
    ...
    @JsonProperty("discount")
    public PaymentLeanGetResponseDtoBuilder discount(PaymentDiscountDto value) {
    ...
    @JsonProperty("fine")
    public PaymentLeanGetResponseDtoBuilder fine(PaymentFineResponseDto value) {
    ...
    @JsonProperty("interest")
    public PaymentLeanGetResponseDtoBuilder interest(PaymentInterestResponseDto value) {
    ...
    @JsonProperty("postalService")
    public PaymentLeanGetResponseDtoBuilder postalService(Boolean value) {
