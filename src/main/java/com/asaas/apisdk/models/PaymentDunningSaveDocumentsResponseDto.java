...
@EqualsAndHashCode
@Jacksonized
public class PaymentDunningSaveDocumentsResponseDto {
   ...
   */
  @JsonProperty("status")
  private JsonNullable<PaymentDunningSaveDocumentsResponsePaymentDunningStatus> status;

  /**
   * Type of payment dunning
   */
  @JsonProperty("type")
  private JsonNullable<PaymentDunningSaveDocumentsResponsePaymentDunningType> type;
  ...
  @JsonIgnore
  public PaymentDunningSaveDocumentsResponsePaymentDunningStatus getStatus() {
    return status.orElse(null);
  }

  @JsonIgnore
  public PaymentDunningSaveDocumentsResponsePaymentDunningType getType() {
  ...
  public static class PaymentDunningSaveDocumentsResponseDtoBuilder {

    private JsonNullable<String> id = JsonNullable.undefined();

    @JsonProperty("id")
    public PaymentDunningSaveDocumentsResponseDtoBuilder id(String value) {
    ...
    @JsonProperty("dunningNumber")
    public PaymentDunningSaveDocumentsResponseDtoBuilder dunningNumber(Long value) {
      this.dunningNumber = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<PaymentDunningSaveDocumentsResponsePaymentDunningStatus> status = JsonNullable.undefined();

    @JsonProperty("status")
    public PaymentDunningSaveDocumentsResponseDtoBuilder status(
      PaymentDunningSaveDocumentsResponsePaymentDunningStatus value
    ) {
      this.status = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<PaymentDunningSaveDocumentsResponsePaymentDunningType> type = JsonNullable.undefined();

    @JsonProperty("type")
    public PaymentDunningSaveDocumentsResponseDtoBuilder type(
      PaymentDunningSaveDocumentsResponsePaymentDunningType value
    ) {
    ...
    @JsonProperty("payment")
    public PaymentDunningSaveDocumentsResponseDtoBuilder payment(String value) {
    ...
    @JsonProperty("requestDate")
    public PaymentDunningSaveDocumentsResponseDtoBuilder requestDate(String value) {
    ...
    @JsonProperty("description")
    public PaymentDunningSaveDocumentsResponseDtoBuilder description(String value) {
    ...
    @JsonProperty("value")
    public PaymentDunningSaveDocumentsResponseDtoBuilder value(Double value) {
    ...
    @JsonProperty("feeValue")
    public PaymentDunningSaveDocumentsResponseDtoBuilder feeValue(Double value) {
    ...
    @JsonProperty("netValue")
    public PaymentDunningSaveDocumentsResponseDtoBuilder netValue(Double value) {
    ...
    @JsonProperty("receivedInCashFeeValue")
    public PaymentDunningSaveDocumentsResponseDtoBuilder receivedInCashFeeValue(Double value) {
    ...
    @JsonProperty("denialReason")
    public PaymentDunningSaveDocumentsResponseDtoBuilder denialReason(String value) {
    ...
    @JsonProperty("cancellationFeeValue")
    public PaymentDunningSaveDocumentsResponseDtoBuilder cancellationFeeValue(Double value) {
    ...
    @JsonProperty("canBeCancelled")
    public PaymentDunningSaveDocumentsResponseDtoBuilder canBeCancelled(Boolean value) {
    ...
    @JsonProperty("cannotBeCancelledReason")
    public PaymentDunningSaveDocumentsResponseDtoBuilder cannotBeCancelledReason(String value) {
    ...
    @JsonProperty("isNecessaryResendDocumentation")
    public PaymentDunningSaveDocumentsResponseDtoBuilder isNecessaryResendDocumentation(Boolean value) {
