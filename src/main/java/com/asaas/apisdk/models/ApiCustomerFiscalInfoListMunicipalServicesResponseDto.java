...
@EqualsAndHashCode
@Jacksonized
public class ApiCustomerFiscalInfoListMunicipalServicesResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiCustomerFiscalInfoListMunicipalServicesResponseDataDto>> data;
  ...
  @JsonIgnore
  public List<ApiCustomerFiscalInfoListMunicipalServicesResponseDataDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiCustomerFiscalInfoListMunicipalServicesResponseDtoBuilder {
