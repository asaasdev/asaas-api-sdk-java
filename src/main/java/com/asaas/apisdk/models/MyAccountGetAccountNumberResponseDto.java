...
@EqualsAndHashCode
@Jacksonized
public class MyAccountGetAccountNumberResponseDto {
  ...
  public static class MyAccountGetAccountNumberResponseDtoBuilder {

    private JsonNullable<String> agency = JsonNullable.undefined();

    @JsonProperty("agency")
    public MyAccountGetAccountNumberResponseDtoBuilder agency(String value) {
    ...
    @JsonProperty("account")
    public MyAccountGetAccountNumberResponseDtoBuilder account(String value) {
    ...
    @JsonProperty("accountDigit")
    public MyAccountGetAccountNumberResponseDtoBuilder accountDigit(String value) {
