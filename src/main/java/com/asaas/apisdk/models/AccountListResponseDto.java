...
public class AccountListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<AccountGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<AccountGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class AccountListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public AccountListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public AccountListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public AccountListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public AccountListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public AccountListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<AccountGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public AccountListResponseDtoBuilder data(List<AccountGetResponseDto> value) {
