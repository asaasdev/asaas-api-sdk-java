...
public class SubscriptionListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<SubscriptionGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<SubscriptionGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class SubscriptionListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public SubscriptionListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public SubscriptionListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public SubscriptionListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public SubscriptionListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public SubscriptionListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<SubscriptionGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public SubscriptionListResponseDtoBuilder data(List<SubscriptionGetResponseDto> value) {
