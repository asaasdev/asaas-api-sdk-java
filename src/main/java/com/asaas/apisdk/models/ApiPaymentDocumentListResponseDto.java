...
@EqualsAndHashCode
@Jacksonized
public class ApiPaymentDocumentListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiPaymentDocumentGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiPaymentDocumentGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiPaymentDocumentListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiPaymentDocumentListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public ApiPaymentDocumentListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public ApiPaymentDocumentListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public ApiPaymentDocumentListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public ApiPaymentDocumentListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<ApiPaymentDocumentGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiPaymentDocumentListResponseDtoBuilder data(List<ApiPaymentDocumentGetResponseDto> value) {
