...
public class FinancialTransactionListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<FinancialTransactionGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<FinancialTransactionGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class FinancialTransactionListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public FinancialTransactionListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public FinancialTransactionListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public FinancialTransactionListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public FinancialTransactionListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public FinancialTransactionListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<FinancialTransactionGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public FinancialTransactionListResponseDtoBuilder data(List<FinancialTransactionGetResponseDto> value) {
