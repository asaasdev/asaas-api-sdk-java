...
@EqualsAndHashCode
@Jacksonized
public class PixTransactionExternalAccountResponseDto {
  ...
  private JsonNullable<PixTransactionExternalAccountResponsePixAddressKeyType> addressKeyType;
  ...
  @JsonIgnore
  public PixTransactionExternalAccountResponsePixAddressKeyType getAddressKeyType() {
    return addressKeyType.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PixTransactionExternalAccountResponseDtoBuilder {

    private JsonNullable<String> ispb = JsonNullable.undefined();

    @JsonProperty("ispb")
    public PixTransactionExternalAccountResponseDtoBuilder ispb(String value) {
    ...
    @JsonProperty("ispbName")
    public PixTransactionExternalAccountResponseDtoBuilder ispbName(String value) {
    ...
    @JsonProperty("name")
    public PixTransactionExternalAccountResponseDtoBuilder name(String value) {
    ...
    @JsonProperty("cpfCnpj")
    public PixTransactionExternalAccountResponseDtoBuilder cpfCnpj(String value) {
    ...
    @JsonProperty("addressKey")
    public PixTransactionExternalAccountResponseDtoBuilder addressKey(String value) {
    ...
    @JsonProperty("addressKeyType")
    public PixTransactionExternalAccountResponseDtoBuilder addressKeyType(
      PixTransactionExternalAccountResponsePixAddressKeyType value
    ) {
