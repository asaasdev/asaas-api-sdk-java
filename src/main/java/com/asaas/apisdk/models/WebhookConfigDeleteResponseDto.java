...
public class WebhookConfigDeleteResponseDto {
  ...
  public static class WebhookConfigDeleteResponseDtoBuilder {

    private JsonNullable<Boolean> deleted = JsonNullable.undefined();

    @JsonProperty("deleted")
    public WebhookConfigDeleteResponseDtoBuilder deleted(Boolean value) {
    ...
    @JsonProperty("id")
    public WebhookConfigDeleteResponseDtoBuilder id(String value) {
