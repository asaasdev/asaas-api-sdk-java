...
@EqualsAndHashCode
@Jacksonized
public class PaymentLimitsResponseCreationDailyDto {
  ...
  public static class PaymentLimitsResponseCreationDailyDtoBuilder {

    private JsonNullable<Long> limit = JsonNullable.undefined();

    @JsonProperty("limit")
    public PaymentLimitsResponseCreationDailyDtoBuilder limit(Long value) {
    ...
    @JsonProperty("used")
    public PaymentLimitsResponseCreationDailyDtoBuilder used(Long value) {
    ...
    @JsonProperty("wasReached")
    public PaymentLimitsResponseCreationDailyDtoBuilder wasReached(Boolean value) {
