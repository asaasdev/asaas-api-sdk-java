...
@EqualsAndHashCode
@Jacksonized
public class ListPaymentsReceivedParameters {
  ...
  public static class ListPaymentsReceivedParametersBuilder {

    private JsonNullable<Long> offset = JsonNullable.undefined();

    @JsonProperty("offset")
    public ListPaymentsReceivedParametersBuilder offset(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ListPaymentsReceivedParametersBuilder limit(Long value) {
      if (value == null) {
