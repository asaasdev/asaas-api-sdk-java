...
@EqualsAndHashCode
@Jacksonized
public class PaymentLinkListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PaymentLinkGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<PaymentLinkGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PaymentLinkListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PaymentLinkListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public PaymentLinkListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public PaymentLinkListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public PaymentLinkListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public PaymentLinkListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PaymentLinkGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public PaymentLinkListResponseDtoBuilder data(List<PaymentLinkGetResponseDto> value) {
