...
@EqualsAndHashCode
@Jacksonized
public class InstallmentSplitGetResponseDto {
  ...
  private JsonNullable<InstallmentSplitGetResponsePaymentSplitCancellationReason> cancellationReason;

  /**
   * Split status
   */
  @JsonProperty("status")
  private JsonNullable<InstallmentSplitGetResponsePaymentSplitStatus> status;
  ...
  @JsonIgnore
  public InstallmentSplitGetResponsePaymentSplitCancellationReason getCancellationReason() {
    return cancellationReason.orElse(null);
  }

  @JsonIgnore
  public InstallmentSplitGetResponsePaymentSplitStatus getStatus() {
  ...
  public static class InstallmentSplitGetResponseDtoBuilder {

    private JsonNullable<String> id = JsonNullable.undefined();

    @JsonProperty("id")
    public InstallmentSplitGetResponseDtoBuilder id(String value) {
    ...
    @JsonProperty("walletId")
    public InstallmentSplitGetResponseDtoBuilder walletId(String value) {
    ...
    @JsonProperty("fixedValue")
    public InstallmentSplitGetResponseDtoBuilder fixedValue(Double value) {
    ...
    @JsonProperty("percentualValue")
    public InstallmentSplitGetResponseDtoBuilder percentualValue(Double value) {
    ...
    @JsonProperty("totalValue")
    public InstallmentSplitGetResponseDtoBuilder totalValue(Double value) {
    ...
    @JsonProperty("cancellationReason")
    public InstallmentSplitGetResponseDtoBuilder cancellationReason(
      InstallmentSplitGetResponsePaymentSplitCancellationReason value
    ) {
      this.cancellationReason = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<InstallmentSplitGetResponsePaymentSplitStatus> status = JsonNullable.undefined();

    @JsonProperty("status")
    public InstallmentSplitGetResponseDtoBuilder status(InstallmentSplitGetResponsePaymentSplitStatus value) {
    ...
    @JsonProperty("externalReference")
    public InstallmentSplitGetResponseDtoBuilder externalReference(String value) {
    ...
    @JsonProperty("description")
    public InstallmentSplitGetResponseDtoBuilder description(String value) {
    ...
    @JsonProperty("installmentNumber")
    public InstallmentSplitGetResponseDtoBuilder installmentNumber(Long value) {
