...
@EqualsAndHashCode
@Jacksonized
public class ApiPushNotificationConfigListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiPushNotificationConfigGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiPushNotificationConfigGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiPushNotificationConfigListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiPushNotificationConfigListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public ApiPushNotificationConfigListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public ApiPushNotificationConfigListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public ApiPushNotificationConfigListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public ApiPushNotificationConfigListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<ApiPushNotificationConfigGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiPushNotificationConfigListResponseDtoBuilder data(List<ApiPushNotificationConfigGetResponseDto> value) {
