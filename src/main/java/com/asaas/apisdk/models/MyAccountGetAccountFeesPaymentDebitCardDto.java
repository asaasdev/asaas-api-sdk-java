...
@EqualsAndHashCode
@Jacksonized
public class MyAccountGetAccountFeesPaymentDebitCardDto {
  ...
  public static class MyAccountGetAccountFeesPaymentDebitCardDtoBuilder {

    private JsonNullable<Double> operationValue = JsonNullable.undefined();

    @JsonProperty("operationValue")
    public MyAccountGetAccountFeesPaymentDebitCardDtoBuilder operationValue(Double value) {
    ...
    @JsonProperty("defaultPercentage")
    public MyAccountGetAccountFeesPaymentDebitCardDtoBuilder defaultPercentage(Double value) {
    ...
    @JsonProperty("daysToReceive")
    public MyAccountGetAccountFeesPaymentDebitCardDtoBuilder daysToReceive(Long value) {
