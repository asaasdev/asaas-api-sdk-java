...
@EqualsAndHashCode
@Jacksonized
public class PixQrCodeDecodeRequestDto {
  ...
  public static class PixQrCodeDecodeRequestDtoBuilder {

    private JsonNullable<Double> changeValue = JsonNullable.undefined();

    @JsonProperty("changeValue")
    public PixQrCodeDecodeRequestDtoBuilder changeValue(Double value) {
