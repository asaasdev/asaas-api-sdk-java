...
@EqualsAndHashCode
@Jacksonized
public class ApiPaymentSplitListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiPaymentSplitGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiPaymentSplitGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiPaymentSplitListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiPaymentSplitListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public ApiPaymentSplitListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public ApiPaymentSplitListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public ApiPaymentSplitListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public ApiPaymentSplitListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<ApiPaymentSplitGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiPaymentSplitListResponseDtoBuilder data(List<ApiPaymentSplitGetResponseDto> value) {
