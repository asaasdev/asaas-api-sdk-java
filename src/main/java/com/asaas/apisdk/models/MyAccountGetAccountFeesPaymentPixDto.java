...
@EqualsAndHashCode
@Jacksonized
public class MyAccountGetAccountFeesPaymentPixDto {
  ...
  public static class MyAccountGetAccountFeesPaymentPixDtoBuilder {

    private JsonNullable<Double> fixedFeeValue = JsonNullable.undefined();

    @JsonProperty("fixedFeeValue")
    public MyAccountGetAccountFeesPaymentPixDtoBuilder fixedFeeValue(Double value) {
    ...
    @JsonProperty("fixedFeeValueWithDiscount")
    public MyAccountGetAccountFeesPaymentPixDtoBuilder fixedFeeValueWithDiscount(Double value) {
    ...
    @JsonProperty("percentageFee")
    public MyAccountGetAccountFeesPaymentPixDtoBuilder percentageFee(Double value) {
    ...
    @JsonProperty("minimumFeeValue")
    public MyAccountGetAccountFeesPaymentPixDtoBuilder minimumFeeValue(Double value) {
    ...
    @JsonProperty("maximumFeeValue")
    public MyAccountGetAccountFeesPaymentPixDtoBuilder maximumFeeValue(Double value) {
    ...
    @JsonProperty("discountExpiration")
    public MyAccountGetAccountFeesPaymentPixDtoBuilder discountExpiration(String value) {
    ...
    @JsonProperty("monthlyCreditsWithoutFee")
    public MyAccountGetAccountFeesPaymentPixDtoBuilder monthlyCreditsWithoutFee(Long value) {
    ...
    @JsonProperty("creditsReceivedOfCurrentMonth")
    public MyAccountGetAccountFeesPaymentPixDtoBuilder creditsReceivedOfCurrentMonth(Long value) {
