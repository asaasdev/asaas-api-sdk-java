...
@EqualsAndHashCode
@Jacksonized
public class ApiCreditBureauReportListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiCreditBureauReportGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiCreditBureauReportGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiCreditBureauReportListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiCreditBureauReportListResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiCreditBureauReportListResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiCreditBureauReportListResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiCreditBureauReportListResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiCreditBureauReportListResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiCreditBureauReportGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiCreditBureauReportListResponseDtoBuilder data(List<ApiCreditBureauReportGetResponseDto> value) {
      if (value == null) {
