...
public class PaymentPixQrCodeResponseDto {
  ...
  public static class PaymentPixQrCodeResponseDtoBuilder {

    private JsonNullable<String> encodedImage = JsonNullable.undefined();

    @JsonProperty("encodedImage")
    public PaymentPixQrCodeResponseDtoBuilder encodedImage(String value) {
    ...
    @JsonProperty("payload")
    public PaymentPixQrCodeResponseDtoBuilder payload(String value) {
    ...
    @JsonProperty("expirationDate")
    public PaymentPixQrCodeResponseDtoBuilder expirationDate(String value) {
