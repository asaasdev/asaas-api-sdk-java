...
@EqualsAndHashCode
@Jacksonized
public class PixTransactionQrCodeSaveRequestDto {
  ...
  public static class PixTransactionQrCodeSaveRequestDtoBuilder {

    private JsonNullable<Double> changeValue = JsonNullable.undefined();

    @JsonProperty("changeValue")
    public PixTransactionQrCodeSaveRequestDtoBuilder changeValue(Double value) {
