...
public class PaymentReceiveInCashRequestDto {
  ...
  public static class PaymentReceiveInCashRequestDtoBuilder {

    private JsonNullable<String> paymentDate = JsonNullable.undefined();

    @JsonProperty("paymentDate")
    public PaymentReceiveInCashRequestDtoBuilder paymentDate(String value) {
    ...
    @JsonProperty("value")
    public PaymentReceiveInCashRequestDtoBuilder value(Double value) {
    ...
    @JsonProperty("notifyCustomer")
    public PaymentReceiveInCashRequestDtoBuilder notifyCustomer(Boolean value) {
