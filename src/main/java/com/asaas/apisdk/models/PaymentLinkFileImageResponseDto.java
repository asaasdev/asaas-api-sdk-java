...
@EqualsAndHashCode
@Jacksonized
public class PaymentLinkFileImageResponseDto {
  ...
  public static class PaymentLinkFileImageResponseDtoBuilder {

    private JsonNullable<String> originalName = JsonNullable.undefined();

    @JsonProperty("originalName")
    public PaymentLinkFileImageResponseDtoBuilder originalName(String value) {
    ...
    @JsonProperty("size")
    public PaymentLinkFileImageResponseDtoBuilder size(Long value) {
    ...
    @JsonProperty("extension")
    public PaymentLinkFileImageResponseDtoBuilder extension(String value) {
    ...
    @JsonProperty("previewUrl")
    public PaymentLinkFileImageResponseDtoBuilder previewUrl(String value) {
    ...
    @JsonProperty("downloadUrl")
    public PaymentLinkFileImageResponseDtoBuilder downloadUrl(String value) {
