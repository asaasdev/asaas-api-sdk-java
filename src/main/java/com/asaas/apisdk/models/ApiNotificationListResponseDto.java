...
@EqualsAndHashCode
@Jacksonized
public class ApiNotificationListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiNotificationGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiNotificationGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiNotificationListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiNotificationListResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiNotificationListResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiNotificationListResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiNotificationListResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiNotificationListResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiNotificationGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiNotificationListResponseDtoBuilder data(List<ApiNotificationGetResponseDto> value) {
      if (value == null) {
