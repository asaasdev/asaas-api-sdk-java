...
@EqualsAndHashCode
@Jacksonized
public class ApiWalletShowResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiWalletGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiWalletGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiWalletShowResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiWalletShowResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiWalletShowResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiWalletShowResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiWalletShowResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiWalletShowResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiWalletGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiWalletShowResponseDtoBuilder data(List<ApiWalletGetResponseDto> value) {
      if (value == null) {
