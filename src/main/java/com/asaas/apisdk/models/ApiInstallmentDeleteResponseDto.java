...
@EqualsAndHashCode
@Jacksonized
public class ApiInstallmentDeleteResponseDto {
  ...
  public static class ApiInstallmentDeleteResponseDtoBuilder {

    private JsonNullable<Boolean> deleted = JsonNullable.undefined();

    @JsonProperty("deleted")
    public ApiInstallmentDeleteResponseDtoBuilder deleted(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("id")
    public ApiInstallmentDeleteResponseDtoBuilder id(String value) {
      if (value == null) {
