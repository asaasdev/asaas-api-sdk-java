...
@EqualsAndHashCode
@Jacksonized
public class ApiCustomerListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiCustomerGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiCustomerGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiCustomerListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiCustomerListResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiCustomerListResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiCustomerListResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiCustomerListResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiCustomerListResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiCustomerGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiCustomerListResponseDtoBuilder data(List<ApiCustomerGetResponseDto> value) {
      if (value == null) {
