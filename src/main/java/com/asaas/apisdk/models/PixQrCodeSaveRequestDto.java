...
@EqualsAndHashCode
@Jacksonized
public class PixQrCodeSaveRequestDto {
  ...
  public static class PixQrCodeSaveRequestDtoBuilder {

    private JsonNullable<String> addressKey = JsonNullable.undefined();

    @JsonProperty("addressKey")
    public PixQrCodeSaveRequestDtoBuilder addressKey(String value) {
    ...
    @JsonProperty("description")
    public PixQrCodeSaveRequestDtoBuilder description(String value) {
    ...
    @JsonProperty("value")
    public PixQrCodeSaveRequestDtoBuilder value(Double value) {
    ...
    @JsonProperty("format")
    public PixQrCodeSaveRequestDtoBuilder format(Format value) {
    ...
    @JsonProperty("expirationDate")
    public PixQrCodeSaveRequestDtoBuilder expirationDate(String value) {
    ...
    @JsonProperty("expirationSeconds")
    public PixQrCodeSaveRequestDtoBuilder expirationSeconds(Long value) {
    ...
    @JsonProperty("allowsMultiplePayments")
    public PixQrCodeSaveRequestDtoBuilder allowsMultiplePayments(Boolean value) {
    ...
    @JsonProperty("externalReference")
    public PixQrCodeSaveRequestDtoBuilder externalReference(String value) {
