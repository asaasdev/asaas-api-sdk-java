...
@EqualsAndHashCode
@Jacksonized
public class InstallmentDeleteResponseDto {
  ...
  public static class InstallmentDeleteResponseDtoBuilder {

    private JsonNullable<Boolean> deleted = JsonNullable.undefined();

    @JsonProperty("deleted")
    public InstallmentDeleteResponseDtoBuilder deleted(Boolean value) {
    ...
    @JsonProperty("id")
    public InstallmentDeleteResponseDtoBuilder id(String value) {
