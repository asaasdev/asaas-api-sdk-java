...
@EqualsAndHashCode
@Jacksonized
public class ApiMobilePhoneRechargeListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiMobilePhoneRechargeGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiMobilePhoneRechargeGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiMobilePhoneRechargeListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiMobilePhoneRechargeListResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiMobilePhoneRechargeListResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiMobilePhoneRechargeListResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiMobilePhoneRechargeListResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiMobilePhoneRechargeListResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiMobilePhoneRechargeGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiMobilePhoneRechargeListResponseDtoBuilder data(List<ApiMobilePhoneRechargeGetResponseDto> value) {
      if (value == null) {
