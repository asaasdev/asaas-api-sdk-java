...
@EqualsAndHashCode
@Jacksonized
public class MobilePhoneRechargeListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<MobilePhoneRechargeGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<MobilePhoneRechargeGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class MobilePhoneRechargeListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public MobilePhoneRechargeListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public MobilePhoneRechargeListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public MobilePhoneRechargeListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public MobilePhoneRechargeListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public MobilePhoneRechargeListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<MobilePhoneRechargeGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public MobilePhoneRechargeListResponseDtoBuilder data(List<MobilePhoneRechargeGetResponseDto> value) {
