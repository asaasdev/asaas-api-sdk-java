...
@EqualsAndHashCode
@Jacksonized
public class ApiPaymentDunningCancelResponseDto {
   ...
   */
  @JsonProperty("status")
  private JsonNullable<ApiPaymentDunningCancelResponsePaymentDunningStatus> status;

  /**
   * Type of payment dunning
   */
  @JsonProperty("type")
  private JsonNullable<ApiPaymentDunningCancelResponsePaymentDunningType> type;
  ...
  @JsonIgnore
  public ApiPaymentDunningCancelResponsePaymentDunningStatus getStatus() {
    return status.orElse(null);
  }

  @JsonIgnore
  public ApiPaymentDunningCancelResponsePaymentDunningType getType() {
  ...
  public static class ApiPaymentDunningCancelResponseDtoBuilder {

    private JsonNullable<String> id = JsonNullable.undefined();

    @JsonProperty("id")
    public ApiPaymentDunningCancelResponseDtoBuilder id(String value) {
      if (value == null) {
    ...
    @JsonProperty("dunningNumber")
    public ApiPaymentDunningCancelResponseDtoBuilder dunningNumber(Long value) {
      if (value == null) {
    ...
    private JsonNullable<ApiPaymentDunningCancelResponsePaymentDunningStatus> status = JsonNullable.undefined();

    @JsonProperty("status")
    public ApiPaymentDunningCancelResponseDtoBuilder status(ApiPaymentDunningCancelResponsePaymentDunningStatus value) {
      if (value == null) {
    ...
    private JsonNullable<ApiPaymentDunningCancelResponsePaymentDunningType> type = JsonNullable.undefined();

    @JsonProperty("type")
    public ApiPaymentDunningCancelResponseDtoBuilder type(ApiPaymentDunningCancelResponsePaymentDunningType value) {
      if (value == null) {
    ...
    @JsonProperty("payment")
    public ApiPaymentDunningCancelResponseDtoBuilder payment(String value) {
      if (value == null) {
    ...
    @JsonProperty("requestDate")
    public ApiPaymentDunningCancelResponseDtoBuilder requestDate(String value) {
      if (value == null) {
    ...
    @JsonProperty("description")
    public ApiPaymentDunningCancelResponseDtoBuilder description(String value) {
      if (value == null) {
    ...
    @JsonProperty("value")
    public ApiPaymentDunningCancelResponseDtoBuilder value(Double value) {
      if (value == null) {
    ...
    @JsonProperty("feeValue")
    public ApiPaymentDunningCancelResponseDtoBuilder feeValue(Double value) {
      if (value == null) {
    ...
    @JsonProperty("netValue")
    public ApiPaymentDunningCancelResponseDtoBuilder netValue(Double value) {
      if (value == null) {
    ...
    @JsonProperty("receivedInCashFeeValue")
    public ApiPaymentDunningCancelResponseDtoBuilder receivedInCashFeeValue(Double value) {
      if (value == null) {
    ...
    @JsonProperty("denialReason")
    public ApiPaymentDunningCancelResponseDtoBuilder denialReason(String value) {
      if (value == null) {
    ...
    @JsonProperty("cancellationFeeValue")
    public ApiPaymentDunningCancelResponseDtoBuilder cancellationFeeValue(Double value) {
      if (value == null) {
    ...
    @JsonProperty("canBeCancelled")
    public ApiPaymentDunningCancelResponseDtoBuilder canBeCancelled(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("cannotBeCancelledReason")
    public ApiPaymentDunningCancelResponseDtoBuilder cannotBeCancelledReason(String value) {
      if (value == null) {
    ...
    @JsonProperty("isNecessaryResendDocumentation")
    public ApiPaymentDunningCancelResponseDtoBuilder isNecessaryResendDocumentation(Boolean value) {
      if (value == null) {
