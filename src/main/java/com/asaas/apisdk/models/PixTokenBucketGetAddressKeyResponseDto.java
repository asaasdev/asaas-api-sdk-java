...
@EqualsAndHashCode
@Jacksonized
public class PixTokenBucketGetAddressKeyResponseDto {
  ...
  public static class PixTokenBucketGetAddressKeyResponseDtoBuilder {

    private JsonNullable<Long> capacity = JsonNullable.undefined();

    @JsonProperty("capacity")
    public PixTokenBucketGetAddressKeyResponseDtoBuilder capacity(Long value) {
    ...
    @JsonProperty("remaining")
    public PixTokenBucketGetAddressKeyResponseDtoBuilder remaining(Long value) {
