...
public class PaymentSplitGetResponseDto {
  ...
  private JsonNullable<PaymentSplitGetResponsePaymentSplitCancellationReason> cancellationReason;

  /**
   * Split status
   */
  @JsonProperty("status")
  private JsonNullable<PaymentSplitGetResponsePaymentSplitStatus> status;
  ...
  @JsonIgnore
  public PaymentSplitGetResponsePaymentSplitCancellationReason getCancellationReason() {
    return cancellationReason.orElse(null);
  }

  @JsonIgnore
  public PaymentSplitGetResponsePaymentSplitStatus getStatus() {
  ...
  public static class PaymentSplitGetResponseDtoBuilder {

    private JsonNullable<String> id = JsonNullable.undefined();

    @JsonProperty("id")
    public PaymentSplitGetResponseDtoBuilder id(String value) {
    ...
    @JsonProperty("walletId")
    public PaymentSplitGetResponseDtoBuilder walletId(String value) {
    ...
    @JsonProperty("fixedValue")
    public PaymentSplitGetResponseDtoBuilder fixedValue(Double value) {
    ...
    @JsonProperty("percentualValue")
    public PaymentSplitGetResponseDtoBuilder percentualValue(Double value) {
    ...
    @JsonProperty("totalValue")
    public PaymentSplitGetResponseDtoBuilder totalValue(Double value) {
    ...
    @JsonProperty("cancellationReason")
    public PaymentSplitGetResponseDtoBuilder cancellationReason(
      PaymentSplitGetResponsePaymentSplitCancellationReason value
    ) {
      this.cancellationReason = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<PaymentSplitGetResponsePaymentSplitStatus> status = JsonNullable.undefined();

    @JsonProperty("status")
    public PaymentSplitGetResponseDtoBuilder status(PaymentSplitGetResponsePaymentSplitStatus value) {
    ...
    @JsonProperty("externalReference")
    public PaymentSplitGetResponseDtoBuilder externalReference(String value) {
    ...
    @JsonProperty("description")
    public PaymentSplitGetResponseDtoBuilder description(String value) {
