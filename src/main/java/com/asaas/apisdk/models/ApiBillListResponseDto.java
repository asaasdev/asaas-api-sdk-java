...
@EqualsAndHashCode
@Jacksonized
public class ApiBillListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiBillGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiBillGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiBillListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiBillListResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiBillListResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiBillListResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiBillListResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiBillListResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiBillGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiBillListResponseDtoBuilder data(List<ApiBillGetResponseDto> value) {
      if (value == null) {
