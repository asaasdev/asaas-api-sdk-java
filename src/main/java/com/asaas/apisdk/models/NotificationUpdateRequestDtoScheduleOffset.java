...
@Getter
@AllArgsConstructor
public enum NotificationUpdateRequestDtoScheduleOffset {
  _0(0),
  _1(1),
  _5(5),
  _7(7),
  ...
  @JsonCreator
  public static NotificationUpdateRequestDtoScheduleOffset fromValue(String value) {
    return Arrays.stream(NotificationUpdateRequestDtoScheduleOffset.values())
