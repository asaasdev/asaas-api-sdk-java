...
public class FiscalInfoListInvoiceNbsCodesResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<FiscalInfoListInvoiceNbsCodesResponseDataDto>> data;
  ...
  @JsonIgnore
  public List<FiscalInfoListInvoiceNbsCodesResponseDataDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class FiscalInfoListInvoiceNbsCodesResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public FiscalInfoListInvoiceNbsCodesResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public FiscalInfoListInvoiceNbsCodesResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public FiscalInfoListInvoiceNbsCodesResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public FiscalInfoListInvoiceNbsCodesResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public FiscalInfoListInvoiceNbsCodesResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<FiscalInfoListInvoiceNbsCodesResponseDataDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public FiscalInfoListInvoiceNbsCodesResponseDtoBuilder data(
      List<FiscalInfoListInvoiceNbsCodesResponseDataDto> value
    ) {
