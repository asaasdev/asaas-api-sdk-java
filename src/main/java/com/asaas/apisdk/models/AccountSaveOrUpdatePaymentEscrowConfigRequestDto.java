...
public class AccountSaveOrUpdatePaymentEscrowConfigRequestDto {
  ...
  public static class AccountSaveOrUpdatePaymentEscrowConfigRequestDtoBuilder {

    private JsonNullable<Boolean> enabled = JsonNullable.undefined();

    @JsonProperty("enabled")
    public AccountSaveOrUpdatePaymentEscrowConfigRequestDtoBuilder enabled(Boolean value) {
    ...
    @JsonProperty("isFeePayer")
    public AccountSaveOrUpdatePaymentEscrowConfigRequestDtoBuilder isFeePayer(Boolean value) {
