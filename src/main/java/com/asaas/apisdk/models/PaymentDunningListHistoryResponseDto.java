...
@EqualsAndHashCode
@Jacksonized
public class PaymentDunningListHistoryResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PaymentDunningListHistoryResponseDataDto>> data;
  ...
  @JsonIgnore
  public List<PaymentDunningListHistoryResponseDataDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PaymentDunningListHistoryResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PaymentDunningListHistoryResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public PaymentDunningListHistoryResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public PaymentDunningListHistoryResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public PaymentDunningListHistoryResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public PaymentDunningListHistoryResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PaymentDunningListHistoryResponseDataDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public PaymentDunningListHistoryResponseDtoBuilder data(List<PaymentDunningListHistoryResponseDataDto> value) {
