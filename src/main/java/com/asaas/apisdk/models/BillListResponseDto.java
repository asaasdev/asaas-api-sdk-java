...
public class BillListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<BillGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<BillGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class BillListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public BillListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public BillListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public BillListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public BillListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public BillListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<BillGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public BillListResponseDtoBuilder data(List<BillGetResponseDto> value) {
