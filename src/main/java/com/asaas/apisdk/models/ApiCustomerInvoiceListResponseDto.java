...
@EqualsAndHashCode
@Jacksonized
public class ApiCustomerInvoiceListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiCustomerInvoiceGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiCustomerInvoiceGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiCustomerInvoiceListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiCustomerInvoiceListResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiCustomerInvoiceListResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiCustomerInvoiceListResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiCustomerInvoiceListResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiCustomerInvoiceListResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiCustomerInvoiceGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiCustomerInvoiceListResponseDtoBuilder data(List<ApiCustomerInvoiceGetResponseDto> value) {
      if (value == null) {
