...
public class FiscalInfoMunicipalOptionsSpecialTaxRegimesDto {
  ...
  public static class FiscalInfoMunicipalOptionsSpecialTaxRegimesDtoBuilder {

    private JsonNullable<String> label = JsonNullable.undefined();

    @JsonProperty("label")
    public FiscalInfoMunicipalOptionsSpecialTaxRegimesDtoBuilder label(String value) {
    ...
    @JsonProperty("value")
    public FiscalInfoMunicipalOptionsSpecialTaxRegimesDtoBuilder value(String value) {
