...
@EqualsAndHashCode
@Jacksonized
public class PaymentLinkFileListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PaymentLinkFileGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<PaymentLinkFileGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PaymentLinkFileListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PaymentLinkFileListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public PaymentLinkFileListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public PaymentLinkFileListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public PaymentLinkFileListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public PaymentLinkFileListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PaymentLinkFileGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public PaymentLinkFileListResponseDtoBuilder data(List<PaymentLinkFileGetResponseDto> value) {
