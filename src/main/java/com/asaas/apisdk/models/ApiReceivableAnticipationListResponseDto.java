...
@EqualsAndHashCode
@Jacksonized
public class ApiReceivableAnticipationListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiReceivableAnticipationGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiReceivableAnticipationGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiReceivableAnticipationListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiReceivableAnticipationListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public ApiReceivableAnticipationListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public ApiReceivableAnticipationListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public ApiReceivableAnticipationListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public ApiReceivableAnticipationListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<ApiReceivableAnticipationGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiReceivableAnticipationListResponseDtoBuilder data(List<ApiReceivableAnticipationGetResponseDto> value) {
