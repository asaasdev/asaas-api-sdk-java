...
@EqualsAndHashCode
@Jacksonized
public class ApiPaymentCampaignFileListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiPaymentCampaignFileGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiPaymentCampaignFileGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiPaymentCampaignFileListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiPaymentCampaignFileListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public ApiPaymentCampaignFileListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public ApiPaymentCampaignFileListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public ApiPaymentCampaignFileListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public ApiPaymentCampaignFileListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<ApiPaymentCampaignFileGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiPaymentCampaignFileListResponseDtoBuilder data(List<ApiPaymentCampaignFileGetResponseDto> value) {
