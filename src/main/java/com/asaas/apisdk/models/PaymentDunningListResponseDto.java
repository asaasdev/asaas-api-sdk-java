...
@EqualsAndHashCode
@Jacksonized
public class PaymentDunningListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PaymentDunningShowResponseDto>> data;
  ...
  @JsonIgnore
  public List<PaymentDunningShowResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PaymentDunningListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PaymentDunningListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public PaymentDunningListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public PaymentDunningListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public PaymentDunningListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public PaymentDunningListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PaymentDunningShowResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public PaymentDunningListResponseDtoBuilder data(List<PaymentDunningShowResponseDto> value) {
