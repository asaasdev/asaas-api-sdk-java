...
@EqualsAndHashCode
@Jacksonized
public class ApiPixQrCodeDecodeRequestDto {
  ...
  public static class ApiPixQrCodeDecodeRequestDtoBuilder {

    private JsonNullable<Double> changeValue = JsonNullable.undefined();

    @JsonProperty("changeValue")
    public ApiPixQrCodeDecodeRequestDtoBuilder changeValue(Double value) {
      if (value == null) {
