...
@EqualsAndHashCode
@Jacksonized
public class PaymentRefundListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PaymentRefundGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<PaymentRefundGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PaymentRefundListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PaymentRefundListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public PaymentRefundListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public PaymentRefundListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public PaymentRefundListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public PaymentRefundListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PaymentRefundGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public PaymentRefundListResponseDtoBuilder data(List<PaymentRefundGetResponseDto> value) {
