...
@EqualsAndHashCode
@Jacksonized
public class ApiPaymentDunningListHistoryResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiPaymentDunningListHistoryResponseDataDto>> data;
  ...
  @JsonIgnore
  public List<ApiPaymentDunningListHistoryResponseDataDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiPaymentDunningListHistoryResponseDtoBuilder {
    ...
    private JsonNullable<List<ApiPaymentDunningListHistoryResponseDataDto>> data = JsonNullable.undefined();
