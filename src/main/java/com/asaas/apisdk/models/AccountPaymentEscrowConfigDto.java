...
public class AccountPaymentEscrowConfigDto {
  ...
  public static class AccountPaymentEscrowConfigDtoBuilder {

    private JsonNullable<Boolean> enabled = JsonNullable.undefined();

    @JsonProperty("enabled")
    public AccountPaymentEscrowConfigDtoBuilder enabled(Boolean value) {
    ...
    @JsonProperty("isFeePayer")
    public AccountPaymentEscrowConfigDtoBuilder isFeePayer(Boolean value) {
