...
@EqualsAndHashCode
@Jacksonized
public class AnticipationSimulateResponseDto {
  ...
  public static class AnticipationSimulateResponseDtoBuilder {

    private JsonNullable<String> installment = JsonNullable.undefined();

    @JsonProperty("installment")
    public AnticipationSimulateResponseDtoBuilder installment(String value) {
    ...
    @JsonProperty("payment")
    public AnticipationSimulateResponseDtoBuilder payment(String value) {
    ...
    @JsonProperty("anticipationDate")
    public AnticipationSimulateResponseDtoBuilder anticipationDate(String value) {
    ...
    @JsonProperty("dueDate")
    public AnticipationSimulateResponseDtoBuilder dueDate(String value) {
    ...
    @JsonProperty("fee")
    public AnticipationSimulateResponseDtoBuilder fee(Double value) {
    ...
    @JsonProperty("anticipationDays")
    public AnticipationSimulateResponseDtoBuilder anticipationDays(Long value) {
    ...
    @JsonProperty("netValue")
    public AnticipationSimulateResponseDtoBuilder netValue(Double value) {
    ...
    @JsonProperty("totalValue")
    public AnticipationSimulateResponseDtoBuilder totalValue(Double value) {
    ...
    @JsonProperty("value")
    public AnticipationSimulateResponseDtoBuilder value(Double value) {
    ...
    @JsonProperty("isDocumentationRequired")
    public AnticipationSimulateResponseDtoBuilder isDocumentationRequired(Boolean value) {
