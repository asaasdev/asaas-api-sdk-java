...
@EqualsAndHashCode
@Jacksonized
public class ListInstallmentsParameters {
  ...
  public static class ListInstallmentsParametersBuilder {

    private JsonNullable<Long> offset = JsonNullable.undefined();

    @JsonProperty("offset")
    public ListInstallmentsParametersBuilder offset(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ListInstallmentsParametersBuilder limit(Long value) {
      if (value == null) {
