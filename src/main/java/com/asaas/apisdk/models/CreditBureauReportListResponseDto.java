...
@EqualsAndHashCode
@Jacksonized
public class CreditBureauReportListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<CreditBureauReportGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<CreditBureauReportGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class CreditBureauReportListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public CreditBureauReportListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public CreditBureauReportListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public CreditBureauReportListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public CreditBureauReportListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public CreditBureauReportListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<CreditBureauReportGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public CreditBureauReportListResponseDtoBuilder data(List<CreditBureauReportGetResponseDto> value) {
