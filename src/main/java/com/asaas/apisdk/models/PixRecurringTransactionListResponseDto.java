...
@EqualsAndHashCode
@Jacksonized
public class PixRecurringTransactionListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PixRecurringTransactionGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<PixRecurringTransactionGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PixRecurringTransactionListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PixRecurringTransactionListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public PixRecurringTransactionListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public PixRecurringTransactionListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public PixRecurringTransactionListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public PixRecurringTransactionListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PixRecurringTransactionGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public PixRecurringTransactionListResponseDtoBuilder data(List<PixRecurringTransactionGetResponseDto> value) {
