...
@EqualsAndHashCode
@Jacksonized
public class ListWebhooksParameters {
  ...
  public static class ListWebhooksParametersBuilder {

    private JsonNullable<Long> offset = JsonNullable.undefined();

    @JsonProperty("offset")
    public ListWebhooksParametersBuilder offset(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ListWebhooksParametersBuilder limit(Long value) {
      if (value == null) {
