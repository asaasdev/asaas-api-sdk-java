...
@EqualsAndHashCode
@Jacksonized
public class PaymentDunningSimulateResponseTypeSimulationItemDto {

  /**
   * Type of payment dunning
   */
  @JsonProperty("type")
  private JsonNullable<PaymentDunningSimulateResponseTypeSimulationItemPaymentDunningType> type;
  ...
  @JsonIgnore
  public PaymentDunningSimulateResponseTypeSimulationItemPaymentDunningType getType() {
  ...
  public static class PaymentDunningSimulateResponseTypeSimulationItemDtoBuilder {

    private JsonNullable<PaymentDunningSimulateResponseTypeSimulationItemPaymentDunningType> type =
      JsonNullable.undefined();

    @JsonProperty("type")
    public PaymentDunningSimulateResponseTypeSimulationItemDtoBuilder type(
      PaymentDunningSimulateResponseTypeSimulationItemPaymentDunningType value
    ) {
    ...
    @JsonProperty("isAllowed")
    public PaymentDunningSimulateResponseTypeSimulationItemDtoBuilder isAllowed(Boolean value) {
    ...
    @JsonProperty("notAllowedReason")
    public PaymentDunningSimulateResponseTypeSimulationItemDtoBuilder notAllowedReason(String value) {
    ...
    @JsonProperty("feeValue")
    public PaymentDunningSimulateResponseTypeSimulationItemDtoBuilder feeValue(Double value) {
    ...
    @JsonProperty("netValue")
    public PaymentDunningSimulateResponseTypeSimulationItemDtoBuilder netValue(Double value) {
    ...
    @JsonProperty("startDate")
    public PaymentDunningSimulateResponseTypeSimulationItemDtoBuilder startDate(String value) {
