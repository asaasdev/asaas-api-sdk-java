...
@EqualsAndHashCode
@Jacksonized
public class ApiSubscriptionListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiSubscriptionGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiSubscriptionGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiSubscriptionListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiSubscriptionListResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiSubscriptionListResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiSubscriptionListResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiSubscriptionListResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiSubscriptionListResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiSubscriptionGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiSubscriptionListResponseDtoBuilder data(List<ApiSubscriptionGetResponseDto> value) {
      if (value == null) {
