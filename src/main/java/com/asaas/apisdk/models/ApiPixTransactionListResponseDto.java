...
@EqualsAndHashCode
@Jacksonized
public class ApiPixTransactionListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiPixTransactionGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiPixTransactionGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiPixTransactionListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiPixTransactionListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public ApiPixTransactionListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public ApiPixTransactionListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public ApiPixTransactionListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public ApiPixTransactionListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<ApiPixTransactionGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiPixTransactionListResponseDtoBuilder data(List<ApiPixTransactionGetResponseDto> value) {
