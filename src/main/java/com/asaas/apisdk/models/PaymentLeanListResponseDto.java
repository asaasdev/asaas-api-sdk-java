...
@EqualsAndHashCode
@Jacksonized
public class PaymentLeanListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PaymentLeanGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<PaymentLeanGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PaymentLeanListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PaymentLeanListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public PaymentLeanListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public PaymentLeanListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public PaymentLeanListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public PaymentLeanListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PaymentLeanGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public PaymentLeanListResponseDtoBuilder data(List<PaymentLeanGetResponseDto> value) {
