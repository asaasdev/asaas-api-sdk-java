...
@EqualsAndHashCode
@Jacksonized
public class ApiSubscriptionDeleteInvoiceConfigResponseDto {
  ...
  public static class ApiSubscriptionDeleteInvoiceConfigResponseDtoBuilder {

    private JsonNullable<Boolean> deleted = JsonNullable.undefined();

    @JsonProperty("deleted")
    public ApiSubscriptionDeleteInvoiceConfigResponseDtoBuilder deleted(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("id")
    public ApiSubscriptionDeleteInvoiceConfigResponseDtoBuilder id(String value) {
      if (value == null) {
