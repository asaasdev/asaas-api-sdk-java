...
@EqualsAndHashCode
@Jacksonized
public class ChargebackListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PaymentChargebackResponseDto>> data;
  ...
  @JsonIgnore
  public List<PaymentChargebackResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ChargebackListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ChargebackListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public ChargebackListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public ChargebackListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public ChargebackListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public ChargebackListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PaymentChargebackResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ChargebackListResponseDtoBuilder data(List<PaymentChargebackResponseDto> value) {
