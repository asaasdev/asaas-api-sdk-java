...
@EqualsAndHashCode
@Jacksonized
public class ListBillPaymentsParameters {
  ...
  public static class ListBillPaymentsParametersBuilder {

    private JsonNullable<Long> offset = JsonNullable.undefined();

    @JsonProperty("offset")
    public ListBillPaymentsParametersBuilder offset(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ListBillPaymentsParametersBuilder limit(Long value) {
      if (value == null) {
