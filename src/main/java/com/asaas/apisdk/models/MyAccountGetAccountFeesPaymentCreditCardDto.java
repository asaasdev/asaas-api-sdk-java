...
@EqualsAndHashCode
@Jacksonized
public class MyAccountGetAccountFeesPaymentCreditCardDto {
  ...
  public static class MyAccountGetAccountFeesPaymentCreditCardDtoBuilder {

    private JsonNullable<Double> operationValue = JsonNullable.undefined();

    @JsonProperty("operationValue")
    public MyAccountGetAccountFeesPaymentCreditCardDtoBuilder operationValue(Double value) {
    ...
    @JsonProperty("oneInstallmentPercentage")
    public MyAccountGetAccountFeesPaymentCreditCardDtoBuilder oneInstallmentPercentage(Double value) {
    ...
    @JsonProperty("upToSixInstallmentsPercentage")
    public MyAccountGetAccountFeesPaymentCreditCardDtoBuilder upToSixInstallmentsPercentage(Double value) {
    ...
    @JsonProperty("upToTwelveInstallmentsPercentage")
    public MyAccountGetAccountFeesPaymentCreditCardDtoBuilder upToTwelveInstallmentsPercentage(Double value) {
    ...
    @JsonProperty("upToTwentyOneInstallmentsPercentage")
    public MyAccountGetAccountFeesPaymentCreditCardDtoBuilder upToTwentyOneInstallmentsPercentage(Double value) {
    ...
    @JsonProperty("discountOneInstallmentPercentage")
    public MyAccountGetAccountFeesPaymentCreditCardDtoBuilder discountOneInstallmentPercentage(Double value) {
    ...
    @JsonProperty("discountUpToSixInstallmentsPercentage")
    public MyAccountGetAccountFeesPaymentCreditCardDtoBuilder discountUpToSixInstallmentsPercentage(Double value) {
    ...
    @JsonProperty("discountUpToTwelveInstallmentsPercentage")
    public MyAccountGetAccountFeesPaymentCreditCardDtoBuilder discountUpToTwelveInstallmentsPercentage(Double value) {
    ...
    @JsonProperty("discountUpToTwentyOneInstallmentsPercentage")
    public MyAccountGetAccountFeesPaymentCreditCardDtoBuilder discountUpToTwentyOneInstallmentsPercentage(
      Double value
    ) {
    ...
    @JsonProperty("discountExpiration")
    public MyAccountGetAccountFeesPaymentCreditCardDtoBuilder discountExpiration(String value) {
    ...
    @JsonProperty("daysToReceive")
    public MyAccountGetAccountFeesPaymentCreditCardDtoBuilder daysToReceive(Long value) {
