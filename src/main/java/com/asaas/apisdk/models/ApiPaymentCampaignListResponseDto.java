...
@EqualsAndHashCode
@Jacksonized
public class ApiPaymentCampaignListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiPaymentCampaignGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiPaymentCampaignGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiPaymentCampaignListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiPaymentCampaignListResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiPaymentCampaignListResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiPaymentCampaignListResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiPaymentCampaignListResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiPaymentCampaignListResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiPaymentCampaignGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiPaymentCampaignListResponseDtoBuilder data(List<ApiPaymentCampaignGetResponseDto> value) {
      if (value == null) {
