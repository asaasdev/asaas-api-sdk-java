...
@EqualsAndHashCode
@Jacksonized
public class ApiTransferListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiTransferGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiTransferGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiTransferListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiTransferListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public ApiTransferListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public ApiTransferListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public ApiTransferListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public ApiTransferListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<ApiTransferGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiTransferListResponseDtoBuilder data(List<ApiTransferGetResponseDto> value) {
