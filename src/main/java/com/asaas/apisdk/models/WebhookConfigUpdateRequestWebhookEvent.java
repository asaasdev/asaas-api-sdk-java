...
@Getter
@AllArgsConstructor
public enum WebhookConfigUpdateRequestWebhookEvent {
  ...
  @JsonCreator
  public static WebhookConfigUpdateRequestWebhookEvent fromValue(String value) {
    return Arrays.stream(WebhookConfigUpdateRequestWebhookEvent.values())
