...
public class ApiPaymentLeanGetResponseDto {
  ...
  private JsonNullable<ApiPaymentLeanGetResponseBillingType> billingType;
   ...
   */
  @JsonProperty("status")
  private JsonNullable<ApiPaymentLeanGetResponsePaymentStatus> status;
  ...
  @JsonIgnore
  public ApiPaymentLeanGetResponseBillingType getBillingType() {
  ...
  @JsonIgnore
  public ApiPaymentLeanGetResponsePaymentStatus getStatus() {
  ...
  public static class ApiPaymentLeanGetResponseDtoBuilder {
    ...
    private JsonNullable<ApiPaymentLeanGetResponseBillingType> billingType = JsonNullable.undefined();
    ...
    private JsonNullable<ApiPaymentLeanGetResponsePaymentStatus> status = JsonNullable.undefined();
