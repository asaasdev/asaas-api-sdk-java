...
@EqualsAndHashCode
@Jacksonized
public class InstallmentListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<InstallmentGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<InstallmentGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class InstallmentListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public InstallmentListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public InstallmentListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public InstallmentListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public InstallmentListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public InstallmentListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<InstallmentGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public InstallmentListResponseDtoBuilder data(List<InstallmentGetResponseDto> value) {
