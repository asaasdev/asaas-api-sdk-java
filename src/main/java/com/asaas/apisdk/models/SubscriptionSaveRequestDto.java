...
public class SubscriptionSaveRequestDto {
   ...
   */
  @NonNull
  private SubscriptionSaveRequestBillingType billingType;
   ...
   */
  @NonNull
  private SubscriptionSaveRequestCycle cycle;
  ...
  public static class SubscriptionSaveRequestDtoBuilder {

    private JsonNullable<PaymentDiscountDto> discount = JsonNullable.undefined();

    @JsonProperty("discount")
    public SubscriptionSaveRequestDtoBuilder discount(PaymentDiscountDto value) {
    ...
    @JsonProperty("interest")
    public SubscriptionSaveRequestDtoBuilder interest(PaymentInterestRequestDto value) {
    ...
    @JsonProperty("fine")
    public SubscriptionSaveRequestDtoBuilder fine(PaymentFineRequestDto value) {
    ...
    @JsonProperty("description")
    public SubscriptionSaveRequestDtoBuilder description(String value) {
    ...
    @JsonProperty("endDate")
    public SubscriptionSaveRequestDtoBuilder endDate(String value) {
    ...
    @JsonProperty("maxPayments")
    public SubscriptionSaveRequestDtoBuilder maxPayments(Long value) {
    ...
    @JsonProperty("externalReference")
    public SubscriptionSaveRequestDtoBuilder externalReference(String value) {
    ...
    @JsonProperty("split")
    public SubscriptionSaveRequestDtoBuilder split(List<SubscriptionSplitRequestDto> value) {
    ...
    @JsonProperty("callback")
    public SubscriptionSaveRequestDtoBuilder callback(PaymentCallbackRequestDto value) {
