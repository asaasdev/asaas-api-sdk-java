...
@Getter
@AllArgsConstructor
public enum FinancialTransactionGetResponseFinancialTransactionType {
  ...
  DEBT_RECOVERY_NEGOTIATION_FINANCIAL_CHARGES("DEBT_RECOVERY_NEGOTIATION_FINANCIAL_CHARGES"),
  ...
  RECEIVABLE_ANTICIPATION_PARTNER_SETTLEMENT("RECEIVABLE_ANTICIPATION_PARTNER_SETTLEMENT"),
  ...
  CUSTOMER_COMMISSION_SETTLEMENT_CREDIT("CUSTOMER_COMMISSION_SETTLEMENT_CREDIT"),
  ...
  ASAAS_CARD_CREDIT_TRANSFER("ASAAS_CARD_CREDIT_TRANSFER"),
  ASAAS_CARD_CREDIT_TRANSFER_CANCELLATION("ASAAS_CARD_CREDIT_TRANSFER_CANCELLATION"),
  ASAAS_CARD_CREDIT_TRANSFER_PARTIAL_CANCELLATION("ASAAS_CARD_CREDIT_TRANSFER_PARTIAL_CANCELLATION"),
  ASAAS_CARD_CREDIT_VOUCHER("ASAAS_CARD_CREDIT_VOUCHER"),
  ASAAS_CARD_CREDIT_VOUCHER_REFUND("ASAAS_CARD_CREDIT_VOUCHER_REFUND"),
  ASAAS_CARD_DEBIT_TRANSFER("ASAAS_CARD_DEBIT_TRANSFER"),
  ASAAS_CARD_DEBIT_TRANSFER_CANCELLATION("ASAAS_CARD_DEBIT_TRANSFER_CANCELLATION"),
  ASAAS_CARD_DEBIT_TRANSFER_PARTIAL_CANCELLATION("ASAAS_CARD_DEBIT_TRANSFER_PARTIAL_CANCELLATION"),
  ASAAS_CARD_TRANSACTION_FEE("ASAAS_CARD_TRANSACTION_FEE"),
  ASAAS_CARD_TRANSACTION_WITHDRAWAL_FEE("ASAAS_CARD_TRANSACTION_WITHDRAWAL_FEE"),
  ...
  ASAAS_CARD_TRANSACTION_WITHDRAWAL_FEE_REFUND("ASAAS_CARD_TRANSACTION_WITHDRAWAL_FEE_REFUND"),
  ASAAS_CARD_TRANSACTION_PARTIAL_REFUND("ASAAS_CARD_TRANSACTION_PARTIAL_REFUND"),
  ASAAS_CARD_TRANSACTION_REFUND_CANCELLATION("ASAAS_CARD_TRANSACTION_REFUND_CANCELLATION"),
  ASAAS_CARD_TRANSACTION_PARTIAL_REFUND_CANCELLATION("ASAAS_CARD_TRANSACTION_PARTIAL_REFUND_CANCELLATION"),
  ASAAS_MONEY_PAYMENT_COMPROMISED_BALANCE("ASAAS_MONEY_PAYMENT_COMPROMISED_BALANCE"),
  ASAAS_MONEY_PAYMENT_COMPROMISED_BALANCE_REFUND("ASAAS_MONEY_PAYMENT_COMPROMISED_BALANCE_REFUND"),
  ASAAS_MONEY_PAYMENT_ANTICIPATION_FEE("ASAAS_MONEY_PAYMENT_ANTICIPATION_FEE"),
  ASAAS_MONEY_PAYMENT_ANTICIPATION_FEE_REFUND("ASAAS_MONEY_PAYMENT_ANTICIPATION_FEE_REFUND"),
  ASAAS_MONEY_PAYMENT_FINANCING_FEE("ASAAS_MONEY_PAYMENT_FINANCING_FEE"),
  ASAAS_MONEY_PAYMENT_FINANCING_FEE_REFUND("ASAAS_MONEY_PAYMENT_FINANCING_FEE_REFUND"),
  ASAAS_MONEY_TRANSACTION_CASHBACK("ASAAS_MONEY_TRANSACTION_CASHBACK"),
  ASAAS_MONEY_TRANSACTION_CASHBACK_REFUND("ASAAS_MONEY_TRANSACTION_CASHBACK_REFUND"),
  ASAAS_MONEY_TRANSACTION_CHARGEBACK("ASAAS_MONEY_TRANSACTION_CHARGEBACK"),
  ASAAS_MONEY_TRANSACTION_CHARGEBACK_REVERSAL("ASAAS_MONEY_TRANSACTION_CHARGEBACK_REVERSAL"),
  ...
  PIX_TRANSACTION_CREDIT_REFUND_CANCELLATION("PIX_TRANSACTION_CREDIT_REFUND_CANCELLATION"),
  ...
  CONTRACTUAL_EFFECT_SETTLEMENT_REVERSAL("CONTRACTUAL_EFFECT_SETTLEMENT_REVERSAL"),
  ...
  EXTERNAL_SETTLEMENT_CONTRACTUAL_EFFECT_BATCH_CREDIT("EXTERNAL_SETTLEMENT_CONTRACTUAL_EFFECT_BATCH_CREDIT"),
  EXTERNAL_SETTLEMENT_CONTRACTUAL_EFFECT_BATCH_REVERSAL("EXTERNAL_SETTLEMENT_CONTRACTUAL_EFFECT_BATCH_REVERSAL"),
  CHILD_ACCOUNT_KNOWN_YOUR_CUSTOMER_BATCH_FEE("CHILD_ACCOUNT_KNOWN_YOUR_CUSTOMER_BATCH_FEE"),
  ...
  PAYMENT_SPLIT_DIVERGENCE_BLOCK_REVERSAL("PAYMENT_SPLIT_DIVERGENCE_BLOCK_REVERSAL"),
  CUSTOMER_ACCOUNT_PAYMENT_BONUS_FEE("CUSTOMER_ACCOUNT_PAYMENT_BONUS_FEE"),
  CUSTOMER_PAYMENT_CUSTODY_CONFIG_FEE("CUSTOMER_PAYMENT_CUSTODY_CONFIG_FEE"),
  CARD_SALE_ITEM_FEE("CARD_SALE_ITEM_FEE"),
  CARD_SALE_ITEM_FEE_REVERSAL("CARD_SALE_ITEM_FEE_REVERSAL"),
  CARD_SALE_RECEIVED("CARD_SALE_RECEIVED"),
  CARD_SALE_REVERSAL("CARD_SALE_REVERSAL"),
  FLAPP_STORE_PLAN_CHARGE_FEE("FLAPP_STORE_PLAN_CHARGE_FEE"),
  ...
  @JsonCreator
  public static FinancialTransactionGetResponseFinancialTransactionType fromValue(String value) {
    return Arrays.stream(FinancialTransactionGetResponseFinancialTransactionType.values())
