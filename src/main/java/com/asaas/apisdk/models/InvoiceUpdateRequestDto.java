...
public class InvoiceUpdateRequestDto {
  ...
  public static class InvoiceUpdateRequestDtoBuilder {

    private JsonNullable<String> serviceDescription = JsonNullable.undefined();

    @JsonProperty("serviceDescription")
    public InvoiceUpdateRequestDtoBuilder serviceDescription(String value) {
    ...
    @JsonProperty("observations")
    public InvoiceUpdateRequestDtoBuilder observations(String value) {
    ...
    @JsonProperty("externalReference")
    public InvoiceUpdateRequestDtoBuilder externalReference(String value) {
    ...
    @JsonProperty("value")
    public InvoiceUpdateRequestDtoBuilder value(Double value) {
    ...
    @JsonProperty("deductions")
    public InvoiceUpdateRequestDtoBuilder deductions(Double value) {
    ...
    @JsonProperty("effectiveDate")
    public InvoiceUpdateRequestDtoBuilder effectiveDate(String value) {
    ...
    @JsonProperty("updatePayment")
    public InvoiceUpdateRequestDtoBuilder updatePayment(Boolean value) {
    ...
    @JsonProperty("taxes")
    public InvoiceUpdateRequestDtoBuilder taxes(InvoiceTaxesDto value) {
