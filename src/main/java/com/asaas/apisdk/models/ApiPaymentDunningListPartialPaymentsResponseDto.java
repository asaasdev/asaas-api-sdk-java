...
@EqualsAndHashCode
@Jacksonized
public class ApiPaymentDunningListPartialPaymentsResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiPaymentDunningListPartialPaymentsResponseDataDto>> data;
  ...
  @JsonIgnore
  public List<ApiPaymentDunningListPartialPaymentsResponseDataDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiPaymentDunningListPartialPaymentsResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiPaymentDunningListPartialPaymentsResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiPaymentDunningListPartialPaymentsResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiPaymentDunningListPartialPaymentsResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiPaymentDunningListPartialPaymentsResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiPaymentDunningListPartialPaymentsResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiPaymentDunningListPartialPaymentsResponseDataDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiPaymentDunningListPartialPaymentsResponseDtoBuilder data(
      List<ApiPaymentDunningListPartialPaymentsResponseDataDto> value
    ) {
      if (value == null) {
