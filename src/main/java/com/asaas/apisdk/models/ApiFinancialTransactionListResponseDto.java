...
@EqualsAndHashCode
@Jacksonized
public class ApiFinancialTransactionListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiFinancialTransactionGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiFinancialTransactionGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiFinancialTransactionListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiFinancialTransactionListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public ApiFinancialTransactionListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public ApiFinancialTransactionListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public ApiFinancialTransactionListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public ApiFinancialTransactionListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<ApiFinancialTransactionGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiFinancialTransactionListResponseDtoBuilder data(List<ApiFinancialTransactionGetResponseDto> value) {
