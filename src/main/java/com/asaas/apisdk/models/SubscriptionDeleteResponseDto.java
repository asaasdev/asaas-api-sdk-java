...
@EqualsAndHashCode
@Jacksonized
public class SubscriptionDeleteResponseDto {
  ...
  public static class SubscriptionDeleteResponseDtoBuilder {

    private JsonNullable<Boolean> deleted = JsonNullable.undefined();

    @JsonProperty("deleted")
    public SubscriptionDeleteResponseDtoBuilder deleted(Boolean value) {
    ...
    @JsonProperty("id")
    public SubscriptionDeleteResponseDtoBuilder id(String value) {
