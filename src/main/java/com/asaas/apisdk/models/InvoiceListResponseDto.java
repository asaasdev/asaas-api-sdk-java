...
public class InvoiceListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<InvoiceGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<InvoiceGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class InvoiceListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public InvoiceListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public InvoiceListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public InvoiceListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public InvoiceListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public InvoiceListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<InvoiceGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public InvoiceListResponseDtoBuilder data(List<InvoiceGetResponseDto> value) {
