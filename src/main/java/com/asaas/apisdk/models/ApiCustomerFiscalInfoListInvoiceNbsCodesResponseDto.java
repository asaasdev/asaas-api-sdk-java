...
@EqualsAndHashCode
@Jacksonized
public class ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDataDto>> data;
  ...
  @JsonIgnore
  public List<ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDataDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDataDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDtoBuilder data(
      List<ApiCustomerFiscalInfoListInvoiceNbsCodesResponseDataDto> value
    ) {
      if (value == null) {
