...
public class FinancialTransactionGetResponseDto {
   ...
   */
  @JsonProperty("type")
  private JsonNullable<FinancialTransactionGetResponseFinancialTransactionType> type;
  ...
  @JsonIgnore
  public FinancialTransactionGetResponseFinancialTransactionType getType() {
  ...
  public static class FinancialTransactionGetResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public FinancialTransactionGetResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("id")
    public FinancialTransactionGetResponseDtoBuilder id(String value) {
    ...
    @JsonProperty("value")
    public FinancialTransactionGetResponseDtoBuilder value(Double value) {
    ...
    @JsonProperty("balance")
    public FinancialTransactionGetResponseDtoBuilder balance(Double value) {
      this.balance = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<FinancialTransactionGetResponseFinancialTransactionType> type = JsonNullable.undefined();

    @JsonProperty("type")
    public FinancialTransactionGetResponseDtoBuilder type(
      FinancialTransactionGetResponseFinancialTransactionType value
    ) {
    ...
    @JsonProperty("date")
    public FinancialTransactionGetResponseDtoBuilder date(String value) {
    ...
    @JsonProperty("description")
    public FinancialTransactionGetResponseDtoBuilder description(String value) {
    ...
    @JsonProperty("paymentId")
    public FinancialTransactionGetResponseDtoBuilder paymentId(String value) {
    ...
    @JsonProperty("splitId")
    public FinancialTransactionGetResponseDtoBuilder splitId(String value) {
    ...
    @JsonProperty("transferId")
    public FinancialTransactionGetResponseDtoBuilder transferId(String value) {
    ...
    @JsonProperty("anticipationId")
    public FinancialTransactionGetResponseDtoBuilder anticipationId(String value) {
    ...
    @JsonProperty("billId")
    public FinancialTransactionGetResponseDtoBuilder billId(String value) {
    ...
    @JsonProperty("invoiceId")
    public FinancialTransactionGetResponseDtoBuilder invoiceId(String value) {
    ...
    @JsonProperty("paymentDunningId")
    public FinancialTransactionGetResponseDtoBuilder paymentDunningId(String value) {
    ...
    @JsonProperty("creditBureauReportId")
    public FinancialTransactionGetResponseDtoBuilder creditBureauReportId(String value) {
