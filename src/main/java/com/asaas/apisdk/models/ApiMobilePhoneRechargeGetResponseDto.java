...
@EqualsAndHashCode
@Jacksonized
public class ApiMobilePhoneRechargeGetResponseDto {
   ...
   */
  @JsonProperty("status")
  private JsonNullable<ApiMobilePhoneRechargeGetResponseMobilePhoneRechargeStatus> status;
  ...
  @JsonIgnore
  public ApiMobilePhoneRechargeGetResponseMobilePhoneRechargeStatus getStatus() {
  ...
  public static class ApiMobilePhoneRechargeGetResponseDtoBuilder {
    ...
    private JsonNullable<ApiMobilePhoneRechargeGetResponseMobilePhoneRechargeStatus> status = JsonNullable.undefined();
