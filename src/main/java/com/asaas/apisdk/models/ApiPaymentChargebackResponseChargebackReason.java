...
@Getter
@AllArgsConstructor
public enum ApiPaymentChargebackResponseChargebackReason {
  ...
  @JsonCreator
  public static ApiPaymentChargebackResponseChargebackReason fromValue(String value) {
    return Arrays.stream(ApiPaymentChargebackResponseChargebackReason.values())
