...
public class CustomerDeleteResponseDto {
  ...
  public static class CustomerDeleteResponseDtoBuilder {

    private JsonNullable<Boolean> deleted = JsonNullable.undefined();

    @JsonProperty("deleted")
    public CustomerDeleteResponseDtoBuilder deleted(Boolean value) {
    ...
    @JsonProperty("id")
    public CustomerDeleteResponseDtoBuilder id(String value) {
