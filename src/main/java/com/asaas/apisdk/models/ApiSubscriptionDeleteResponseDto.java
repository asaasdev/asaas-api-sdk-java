...
@EqualsAndHashCode
@Jacksonized
public class ApiSubscriptionDeleteResponseDto {
  ...
  public static class ApiSubscriptionDeleteResponseDtoBuilder {

    private JsonNullable<Boolean> deleted = JsonNullable.undefined();

    @JsonProperty("deleted")
    public ApiSubscriptionDeleteResponseDtoBuilder deleted(Boolean value) {
    ...
    @JsonProperty("id")
    public ApiSubscriptionDeleteResponseDtoBuilder id(String value) {
