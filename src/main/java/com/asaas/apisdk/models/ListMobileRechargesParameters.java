...
@EqualsAndHashCode
@Jacksonized
public class ListMobileRechargesParameters {
  ...
  public static class ListMobileRechargesParametersBuilder {

    private JsonNullable<Long> offset = JsonNullable.undefined();

    @JsonProperty("offset")
    public ListMobileRechargesParametersBuilder offset(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ListMobileRechargesParametersBuilder limit(Long value) {
      if (value == null) {
