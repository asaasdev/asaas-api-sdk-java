...
@EqualsAndHashCode
@Jacksonized
public class ApiPaymentLeanListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiPaymentLeanGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiPaymentLeanGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiPaymentLeanListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiPaymentLeanListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public ApiPaymentLeanListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public ApiPaymentLeanListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public ApiPaymentLeanListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public ApiPaymentLeanListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<ApiPaymentLeanGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiPaymentLeanListResponseDtoBuilder data(List<ApiPaymentLeanGetResponseDto> value) {
