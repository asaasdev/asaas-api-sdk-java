...
public class TransferListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<TransferGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<TransferGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class TransferListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public TransferListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public TransferListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public TransferListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public TransferListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public TransferListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<TransferGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public TransferListResponseDtoBuilder data(List<TransferGetResponseDto> value) {
