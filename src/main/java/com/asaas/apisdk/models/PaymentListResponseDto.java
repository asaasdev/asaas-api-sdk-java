...
public class PaymentListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PaymentGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<PaymentGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PaymentListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PaymentListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public PaymentListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public PaymentListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public PaymentListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public PaymentListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PaymentGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public PaymentListResponseDtoBuilder data(List<PaymentGetResponseDto> value) {
