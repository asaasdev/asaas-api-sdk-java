...
public class NotificationListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<NotificationGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<NotificationGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class NotificationListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public NotificationListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public NotificationListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public NotificationListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public NotificationListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public NotificationListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<NotificationGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public NotificationListResponseDtoBuilder data(List<NotificationGetResponseDto> value) {
