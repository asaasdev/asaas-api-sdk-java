...
@EqualsAndHashCode
@Jacksonized
public class PixTransactionListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PixTransactionGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<PixTransactionGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PixTransactionListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PixTransactionListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public PixTransactionListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public PixTransactionListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public PixTransactionListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public PixTransactionListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PixTransactionGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public PixTransactionListResponseDtoBuilder data(List<PixTransactionGetResponseDto> value) {
