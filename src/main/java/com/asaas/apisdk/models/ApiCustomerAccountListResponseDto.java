...
public class ApiCustomerAccountListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiCustomerAccountGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiCustomerAccountGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiCustomerAccountListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiCustomerAccountListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public ApiCustomerAccountListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public ApiCustomerAccountListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public ApiCustomerAccountListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public ApiCustomerAccountListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<ApiCustomerAccountGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiCustomerAccountListResponseDtoBuilder data(List<ApiCustomerAccountGetResponseDto> value) {
