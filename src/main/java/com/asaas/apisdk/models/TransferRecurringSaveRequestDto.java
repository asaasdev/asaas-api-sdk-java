...
public class TransferRecurringSaveRequestDto {
  ...
  private JsonNullable<TransferRecurringSaveRequestRecurringCheckoutScheduleFrequency> frequency;
  ...
  @JsonIgnore
  public TransferRecurringSaveRequestRecurringCheckoutScheduleFrequency getFrequency() {
  ...
  public static class TransferRecurringSaveRequestDtoBuilder {

    private JsonNullable<TransferRecurringSaveRequestRecurringCheckoutScheduleFrequency> frequency =
      JsonNullable.undefined();

    @JsonProperty("frequency")
    public TransferRecurringSaveRequestDtoBuilder frequency(
      TransferRecurringSaveRequestRecurringCheckoutScheduleFrequency value
    ) {
    ...
    @JsonProperty("quantity")
    public TransferRecurringSaveRequestDtoBuilder quantity(Long value) {
