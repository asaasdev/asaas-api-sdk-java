...
@EqualsAndHashCode
@Jacksonized
public class ApiChargebackListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiPaymentChargebackResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiPaymentChargebackResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiChargebackListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiChargebackListResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiChargebackListResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiChargebackListResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiChargebackListResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiChargebackListResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiPaymentChargebackResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiChargebackListResponseDtoBuilder data(List<ApiPaymentChargebackResponseDto> value) {
      if (value == null) {
