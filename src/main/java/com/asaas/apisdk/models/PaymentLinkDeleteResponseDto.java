...
@EqualsAndHashCode
@Jacksonized
public class PaymentLinkDeleteResponseDto {
  ...
  public static class PaymentLinkDeleteResponseDtoBuilder {

    private JsonNullable<Boolean> deleted = JsonNullable.undefined();

    @JsonProperty("deleted")
    public PaymentLinkDeleteResponseDtoBuilder deleted(Boolean value) {
    ...
    @JsonProperty("id")
    public PaymentLinkDeleteResponseDtoBuilder id(String value) {
