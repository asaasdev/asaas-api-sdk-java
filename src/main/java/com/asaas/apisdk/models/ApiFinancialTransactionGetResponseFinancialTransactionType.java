...
@Getter
@AllArgsConstructor
public enum ApiFinancialTransactionGetResponseFinancialTransactionType {
  ...
  @JsonCreator
  public static ApiFinancialTransactionGetResponseFinancialTransactionType fromValue(String value) {
    return Arrays.stream(ApiFinancialTransactionGetResponseFinancialTransactionType.values())
