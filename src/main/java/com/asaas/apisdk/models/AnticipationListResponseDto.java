...
@EqualsAndHashCode
@Jacksonized
public class AnticipationListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<AnticipationGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<AnticipationGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class AnticipationListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public AnticipationListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public AnticipationListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public AnticipationListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public AnticipationListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public AnticipationListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<AnticipationGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public AnticipationListResponseDtoBuilder data(List<AnticipationGetResponseDto> value) {
