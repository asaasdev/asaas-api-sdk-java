...
@EqualsAndHashCode
@Jacksonized
public class ApiPaymentDeleteResponseDto {
  ...
  public static class ApiPaymentDeleteResponseDtoBuilder {

    private JsonNullable<Boolean> deleted = JsonNullable.undefined();

    @JsonProperty("deleted")
    public ApiPaymentDeleteResponseDtoBuilder deleted(Boolean value) {
    ...
    @JsonProperty("id")
    public ApiPaymentDeleteResponseDtoBuilder id(String value) {
