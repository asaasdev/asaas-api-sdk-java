...
@EqualsAndHashCode
@Jacksonized
public class ApiPaymentDunningListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<ApiPaymentDunningShowResponseDto>> data;
  ...
  @JsonIgnore
  public List<ApiPaymentDunningShowResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ApiPaymentDunningListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public ApiPaymentDunningListResponseDtoBuilder object(String value) {
      if (value == null) {
    ...
    @JsonProperty("hasMore")
    public ApiPaymentDunningListResponseDtoBuilder hasMore(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("totalCount")
    public ApiPaymentDunningListResponseDtoBuilder totalCount(Long value) {
      if (value == null) {
    ...
    @JsonProperty("limit")
    public ApiPaymentDunningListResponseDtoBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("offset")
    public ApiPaymentDunningListResponseDtoBuilder offset(Long value) {
      if (value == null) {
    ...
    private JsonNullable<List<ApiPaymentDunningShowResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public ApiPaymentDunningListResponseDtoBuilder data(List<ApiPaymentDunningShowResponseDto> value) {
      if (value == null) {
