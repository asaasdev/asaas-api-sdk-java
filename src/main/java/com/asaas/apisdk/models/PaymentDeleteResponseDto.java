...
public class PaymentDeleteResponseDto {
  ...
  public static class PaymentDeleteResponseDtoBuilder {

    private JsonNullable<Boolean> deleted = JsonNullable.undefined();

    @JsonProperty("deleted")
    public PaymentDeleteResponseDtoBuilder deleted(Boolean value) {
    ...
    @JsonProperty("id")
    public PaymentDeleteResponseDtoBuilder id(String value) {
