...
@Getter
@AllArgsConstructor
public enum WebhookConfigSaveRequestWebhookEvent {
  ...
  @JsonCreator
  public static WebhookConfigSaveRequestWebhookEvent fromValue(String value) {
    return Arrays.stream(WebhookConfigSaveRequestWebhookEvent.values())
