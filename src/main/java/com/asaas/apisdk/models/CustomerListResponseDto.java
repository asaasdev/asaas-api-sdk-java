...
public class CustomerListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<CustomerGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<CustomerGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class CustomerListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public CustomerListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public CustomerListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public CustomerListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public CustomerListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public CustomerListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<CustomerGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public CustomerListResponseDtoBuilder data(List<CustomerGetResponseDto> value) {
