...
@EqualsAndHashCode
@Jacksonized
public class PaymentDocumentListResponseDto {
   ...
   */
  @JsonProperty("data")
  private JsonNullable<List<PaymentDocumentGetResponseDto>> data;
  ...
  @JsonIgnore
  public List<PaymentDocumentGetResponseDto> getData() {
    return data.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class PaymentDocumentListResponseDtoBuilder {

    private JsonNullable<String> object = JsonNullable.undefined();

    @JsonProperty("object")
    public PaymentDocumentListResponseDtoBuilder object(String value) {
    ...
    @JsonProperty("hasMore")
    public PaymentDocumentListResponseDtoBuilder hasMore(Boolean value) {
    ...
    @JsonProperty("totalCount")
    public PaymentDocumentListResponseDtoBuilder totalCount(Long value) {
    ...
    @JsonProperty("limit")
    public PaymentDocumentListResponseDtoBuilder limit(Long value) {
    ...
    @JsonProperty("offset")
    public PaymentDocumentListResponseDtoBuilder offset(Long value) {
      this.offset = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<PaymentDocumentGetResponseDto>> data = JsonNullable.undefined();

    @JsonProperty("data")
    public PaymentDocumentListResponseDtoBuilder data(List<PaymentDocumentGetResponseDto> value) {
