...
public class ApiPaymentDocumentDeleteResponseDto {
  ...
  public static class ApiPaymentDocumentDeleteResponseDtoBuilder {

    private JsonNullable<Boolean> deleted = JsonNullable.undefined();

    @JsonProperty("deleted")
    public ApiPaymentDocumentDeleteResponseDtoBuilder deleted(Boolean value) {
      if (value == null) {
    ...
    @JsonProperty("id")
    public ApiPaymentDocumentDeleteResponseDtoBuilder id(String value) {
      if (value == null) {
