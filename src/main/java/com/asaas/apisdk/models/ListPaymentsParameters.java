...
public class ListPaymentsParameters {
  ...
  public static class ListPaymentsParametersBuilder {
    ...
    @JsonProperty("billingType")
    public ListPaymentsParametersBuilder billingType(PaymentListRequestBillingType value) {
      if (value == null) {
    ...
    @JsonProperty("status")
    public ListPaymentsParametersBuilder status(PaymentListRequestPaymentStatus value) {
      if (value == null) {
    ...
    @JsonProperty("invoiceStatus")
    public ListPaymentsParametersBuilder invoiceStatus(PaymentListRequestInvoiceStatus value) {
      if (value == null) {
