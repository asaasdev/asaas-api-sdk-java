...
@EqualsAndHashCode
@Jacksonized
public class PaymentPayWithCreditCardRequestDto {
  ...
  public static class PaymentPayWithCreditCardRequestDtoBuilder {

    private JsonNullable<String> creditCardToken = JsonNullable.undefined();

    @JsonProperty("creditCardToken")
    public PaymentPayWithCreditCardRequestDtoBuilder creditCardToken(String value) {
