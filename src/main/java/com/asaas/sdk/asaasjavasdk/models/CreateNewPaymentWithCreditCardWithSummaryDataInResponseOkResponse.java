...
@EqualsAndHashCode
@Jacksonized
public class CreateNewPaymentWithCreditCardWithSummaryDataInResponseOkResponse {
   ...
   */
  private ApiPaymentLeanSaveWithCreditCardResponseBillingType billingType;
   ...
   * Payment status
   */
  private ApiPaymentLeanSaveWithCreditCardResponsePaymentStatus status;
