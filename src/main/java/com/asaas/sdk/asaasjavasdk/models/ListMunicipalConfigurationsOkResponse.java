...
@EqualsAndHashCode
@Jacksonized
public class ListMunicipalConfigurationsOkResponse {
   ...
   */
  private List<SpecialTaxRegimesList> specialTaxRegimesList;

  /**
   * Special taxation regime options
   */
  private List<NationalPortalTaxCalculationRegimeList> nationalPortalTaxCalculationRegimeList;
