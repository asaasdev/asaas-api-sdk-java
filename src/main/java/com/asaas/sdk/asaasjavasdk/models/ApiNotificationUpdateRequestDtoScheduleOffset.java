...
@Getter
@AllArgsConstructor
public enum ApiNotificationUpdateRequestDtoScheduleOffset {
  _0(0),
  _1(1),
  _5(5),
  _7(7),
  ...
  @JsonCreator
  public static ApiNotificationUpdateRequestDtoScheduleOffset fromValue(String value) {
    return Arrays.stream(ApiNotificationUpdateRequestDtoScheduleOffset.values())
