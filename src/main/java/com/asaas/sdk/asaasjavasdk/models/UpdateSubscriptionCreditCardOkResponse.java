...
@EqualsAndHashCode
@Jacksonized
public class UpdateSubscriptionCreditCardOkResponse {
   ...
   * Billing type
   */
  private ApiSubscriptionGetResponseBillingType billingType;

  /**
   * Billing frequency
   */
  private ApiSubscriptionGetResponseCycle cycle;
   ...
   * Subscription status
   */
  private ApiSubscriptionGetResponseSubscriptionStatus status;
   ...
   * Split information
   */
  private List<UpdateSubscriptionCreditCardOkResponseSplit> split;
}
