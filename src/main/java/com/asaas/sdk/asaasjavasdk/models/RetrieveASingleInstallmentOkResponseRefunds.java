...
@EqualsAndHashCode
@Jacksonized
public class RetrieveASingleInstallmentOkResponseRefunds {
   ...
   * Refund status
   */
  private ApiInstallmentRefundResponsePaymentRefundStatus status;
   ...
   */
  private List<RefundsRefundedSplits2> refundedSplits;
