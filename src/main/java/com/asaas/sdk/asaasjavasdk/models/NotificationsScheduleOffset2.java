...
@Getter
@AllArgsConstructor
public enum NotificationsScheduleOffset2 {
  _0(0),
  _1(1),
  _5(5),
  _7(7),
  ...
  @JsonCreator
  public static NotificationsScheduleOffset2 fromValue(String value) {
    return Arrays.stream(NotificationsScheduleOffset2.values())
