...
@EqualsAndHashCode
@Jacksonized
public class CreateNewPaymentOkResponseSplit {
   ...
   */
  private ApiPaymentSplitGetResponsePaymentSplitCancellationReason cancellationReason;

  /**
   * Split status
   */
  private ApiPaymentSplitGetResponsePaymentSplitStatus status;
