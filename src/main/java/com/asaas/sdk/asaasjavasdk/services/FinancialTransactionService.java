...
public class FinancialTransactionService extends BaseService {
   ...
   * Retrieve extract
   *
   * @return response of {@code RetrieveExtractOkResponse}
   */
  public RetrieveExtractOkResponse retrieveExtract() throws ApiError, ValidationException {
   ...
   * @return response of {@code RetrieveExtractOkResponse}
   */
  public RetrieveExtractOkResponse retrieveExtract(@NonNull RetrieveExtractParameters requestParameters)
    ...
    return ModelConverter.convert(response, new TypeReference<RetrieveExtractOkResponse>() {});
  }

  /**
   * Retrieve extract
   *
   * @return response of {@code CompletableFuture<RetrieveExtractOkResponse>}
   */
  public CompletableFuture<RetrieveExtractOkResponse> retrieveExtractAsync() throws ApiError, ValidationException {
   ...
   * @return response of {@code CompletableFuture<RetrieveExtractOkResponse>}
   */
  public CompletableFuture<RetrieveExtractOkResponse> retrieveExtractAsync(
    ...
    return futureResponse.thenApplyAsync(response ->
      ModelConverter.convert(response, new TypeReference<RetrieveExtractOkResponse>() {})
    );
  }
