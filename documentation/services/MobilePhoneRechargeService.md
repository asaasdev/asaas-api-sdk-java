...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ListMobileRechargesOkResponse response = asaasSdk.mobilePhoneRecharge.listMobileRecharges(requestParameters);
...
| Name                   | Type                                                          | Required | Description  |
| :--------------------- | :------------------------------------------------------------ | :------- | :----------- |
| requestRechargeRequest | [RequestRechargeRequest](../models/RequestRechargeRequest.md) | ❌       | Request Body |
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    RequestRechargeRequest requestRechargeRequest = RequestRechargeRequest.builder()
      .value(15D)
...
`CancelACellphoneRechargeOkResponse`
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CancelACellphoneRechargeOkResponse response = asaasSdk.mobilePhoneRecharge.cancelACellphoneRecharge(
      "37c22147-4194-11ec-8061-0242ac120002",
      new Object()
    );
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    SearchForCellPhoneProviderOkResponse response = asaasSdk.mobilePhoneRecharge.searchForCellPhoneProvider(
      "63997365512"
    );
