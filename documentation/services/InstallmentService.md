...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ListInstallmentsParameters requestParameters = ListInstallmentsParameters.builder().offset(5L).limit(10L).build();

    ListInstallmentsOkResponse response = asaasSdk.installment.listInstallments(requestParameters);
...
| Name                     | Type                                                              | Required | Description  |
| :----------------------- | :---------------------------------------------------------------- | :------- | :----------- |
| createInstallmentRequest | [CreateInstallmentRequest](../models/CreateInstallmentRequest.md) | ❌       | Request Body |
...
import com.asaas.sdk.asaasjavasdk.models.CreateInstallmentRequestSplits;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CreateInstallmentRequestSplits createInstallmentRequestSplits = CreateInstallmentRequestSplits.builder()
      .walletId("walletId")
      .fixedValue(2.05D)
      .percentualValue(8.38D)
      .totalFixedValue(0.48D)
      .externalReference("externalReference")
      .description("description")
      .installmentNumber(6L)
      .build();

    List<CreateInstallmentRequestSplits> splitsList = Arrays.asList(createInstallmentRequestSplits);

    CreateInstallmentRequest createInstallmentRequest = CreateInstallmentRequest.builder()
      .installmentCount(3L)
    ...
    ApiInstallmentGetResponseDto response = asaasSdk.installment.createInstallment(createInstallmentRequest);
...
| Name                                   | Type                                                                                          | Required | Description  |
| :------------------------------------- | :-------------------------------------------------------------------------------------------- | :------- | :----------- |
| createInstallmentWithCreditCardRequest | [CreateInstallmentWithCreditCardRequest](../models/CreateInstallmentWithCreditCardRequest.md) | ❌       | Request Body |
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ApiInstallmentSplitRequestDto apiInstallmentSplitRequestDto = ApiInstallmentSplitRequestDto.builder()
      .walletId("walletId")
      .fixedValue(6.56D)
      .percentualValue(3.69D)
      .totalFixedValue(7.86D)
      .externalReference("externalReference")
      .description("description")
      .installmentNumber(8L)
      .build();
    ...
    CreateInstallmentWithCreditCardRequest createInstallmentWithCreditCardRequest =
      CreateInstallmentWithCreditCardRequest.builder()
        .installmentCount(3L)
        .customer("cus_G7Dvo4iphUNk")
        .value(100D)
        .totalValue(150D)
...
`RetrieveASingleInstallmentOkResponse`
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    RetrieveASingleInstallmentOkResponse response = asaasSdk.installment.retrieveASingleInstallment(
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    RemoveInstallmentOkResponse response = asaasSdk.installment.removeInstallment(
...
| updateInstallmentSplitsRequest | [UpdateInstallmentSplitsRequest](../models/UpdateInstallmentSplitsRequest.md) | ❌       | Request Body   |
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    UpdateInstallmentSplitsRequest updateInstallmentSplitsRequest = UpdateInstallmentSplitsRequest.builder()
      .splits(splitsList)
      .build();

    UpdateInstallmentSplitsOkResponse response = asaasSdk.installment.updateInstallmentSplits(
      "2765d086-c7c5-5cca-898a-4262d212587c",
