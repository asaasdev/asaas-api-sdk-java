...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ListInvoicesOkResponse response = asaasSdk.invoice.listInvoices(requestParameters);
...
| Name                   | Type                                                          | Required | Description  |
| :--------------------- | :------------------------------------------------------------ | :------- | :----------- |
| scheduleInvoiceRequest | [ScheduleInvoiceRequest](../models/ScheduleInvoiceRequest.md) | ❌       | Request Body |
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ScheduleInvoiceRequest scheduleInvoiceRequest = ScheduleInvoiceRequest.builder()
    ...
    ApiCustomerInvoiceGetResponseDto response = asaasSdk.invoice.scheduleInvoice(scheduleInvoiceRequest);
...
| :------------------- | :-------------------------------------------------------- | :------- | :--------------------------------- |
| id                   | String                                                    | ✅       | Unique invoice identifier in Asaas |
| updateInvoiceRequest | [UpdateInvoiceRequest](../models/UpdateInvoiceRequest.md) | ❌       | Request Body                       |
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    UpdateInvoiceRequest updateInvoiceRequest = UpdateInvoiceRequest.builder()
      .serviceDescription("serviceDescription")
      .observations("Monthly for June work.")
      .externalReference("externalReference")
      .value(300D)
...
| :--------------------- | :------------------------------------------------------------ | :------- | :--------------------------------- |
| id                     | String                                                        | ✅       | Unique invoice identifier in Asaas |
| cancelAnInvoiceRequest | [CancelAnInvoiceRequest](../models/CancelAnInvoiceRequest.md) | ❌       | Request Body                       |

**Return Type**

`CancelAnInvoiceOkResponse`
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CancelAnInvoiceRequest cancelAnInvoiceRequest = CancelAnInvoiceRequest.builder().cancelOnlyOnAsaas(true).build();

    CancelAnInvoiceOkResponse response = asaasSdk.invoice.cancelAnInvoice("inv_000000000232", cancelAnInvoiceRequest);
