...
| createAChargebackDisputeRequest | [CreateAChargebackDisputeRequest](../models/CreateAChargebackDisputeRequest.md) | ❌       | Request Body                                                           |

**Return Type**

`CreateAChargebackDisputeOkResponse`
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CreateAChargebackDisputeRequest createAChargebackDisputeRequest = CreateAChargebackDisputeRequest.builder()
      .files(files)
      .build();

    CreateAChargebackDisputeOkResponse response = asaasSdk.chargeback.createAChargebackDispute(
      "8e784c3e-afe8-4844-bb93-6b445763",
      createAChargebackDisputeRequest
    );
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ListChargebacksOkResponse response = asaasSdk.chargeback.listChargebacks(requestParameters);
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    RetrieveASingleChargebackOkResponse response = asaasSdk.chargeback.retrieveASingleChargeback(
