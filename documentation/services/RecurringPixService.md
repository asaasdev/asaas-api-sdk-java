...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ListRecurrencesOkResponse response = asaasSdk.recurringPix.listRecurrences(requestParameters);
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CancelARecurrenceOkResponse response = asaasSdk.recurringPix.cancelARecurrence(
      "35363f6e-93e2-11ec-b9d9-96f4053b1bd4",
      new Object()
    );
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ListRecurrenceItemsOkResponse response = asaasSdk.recurringPix.listRecurrenceItems(
      "35363f6e-93e2-11ec-b9d9-96f4053b1bd4",
      requestParameters
    );
...
`CancelARecurrenceItemOkResponse`
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CancelARecurrenceItemOkResponse response = asaasSdk.recurringPix.cancelARecurrenceItem(
